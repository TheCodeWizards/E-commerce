    ...
    >
      {
        data?.slice(0, 7).map((item) => (
          ...
          <SwiperSlide className='bg-gradient-to-r from-[#0f0c29] via-[#302b63]  to-[#24243e]'>
            <div className='md:h-[607px] flex md:flex-row flex-col px-4 md:gap-x-15 py-21 md:px-40 justify-between items-center'>
              ...
              <div className='flex-1'>
                <Link to={`/product/${item.id}`}>
                  <img src={item.image}
                    className='rounded-full w-[300px] md:w-[530px] shadow-2xl shadow-red-400 hover:scale-[1.05]  duration-100 cursor-pointer ' />
                </Link>
              </div>
            </div>
          </SwiperSlide>
